...
public class httpDemoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LOG_CAT=httpDemoActivity.class.getSimpleName();
    ...
    class featchWeatherAsynch extends AsyncTask<Void,Void,Void>{
        ...
        protected Void doInBackground(Void... params) {
            try {
                ...
                url = new URL("http://api.openweathermap.org/data/2.5/weather?q=hubli,IN&APPID=11111111111111111111111111111111");
